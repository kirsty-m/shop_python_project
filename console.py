...
manufacturer_1 = Manufacturer("Spirit Publishing Ltd", "UK", "Peter Venkman")
manufacturer_repository.save(manufacturer_1)

manufacturer_2 = Manufacturer("Crystals-R-Us", "UK", "Ray Stantz")
manufacturer_repository.save(manufacturer_2)

manufacturer_3 = Manufacturer("Ghostly Electronics", "USA", "Egon Spengler")
...
product_2 = Product("Crystal Ball", "120mm", 5, 30, 75, "Clarevoyancy", manufacturer_2)
